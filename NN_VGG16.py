...
train_datagen = ImageDataGenerator(rescale=1./255, rotation_range=42, brightness_range=(10,120), shear_range=0.2, zoom_range=0.2, horizontal_flip = True, vertical_flip = True)
